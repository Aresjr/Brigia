...
import { Home, User, Calendar, LogIn, UserPlus, Stethoscope, ChevronRight, MessageSquare, DollarSign, ChevronUp, Trash2,
  ...
  CalendarPlus, CalendarCheck, HandCoins, FileHeart, Check, Printer, History, Eye, FileText, Inbox, UserRound
  ...
  providers: [
    ...
    importProvidersFrom(
      LucideAngularModule.pick({ Home, User, Calendar, LogIn, UserPlus, Stethoscope, ChevronRight, CalendarCheck,
        ...
        History, Eye, FileText, Inbox, UserRound, Trash2, ChevronUp
       }),
