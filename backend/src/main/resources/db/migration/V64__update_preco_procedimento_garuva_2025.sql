...
-- Garantir convênios necessários
INSERT INTO convenio (nome)
SELECT 'COMPLEMENTO MÉDICO'
WHERE NOT EXISTS (SELECT 1 FROM convenio WHERE nome = 'COMPLEMENTO MÉDICO');

INSERT INTO convenio (nome)
SELECT 'INDEPENDENTE'
WHERE NOT EXISTS (SELECT 1 FROM convenio WHERE nome = 'INDEPENDENTE');

INSERT INTO convenio (nome)
SELECT 'VALOR MINIMO'
WHERE NOT EXISTS (SELECT 1 FROM convenio WHERE nome = 'VALOR MINIMO');
