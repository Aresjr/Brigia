...
public record UsuarioRequest(
        ...
        @Size(min = 6, message = "A senha deve ter no mínimo 6 caracteres") @NotBlank(message = "A senha é obrigatória") String senha,
        @NotBlank(message = "O nome é obrigatório") String nome, String avatarUrl,
        @NotEmpty(message = "O nível de acesso é obrigatório") List<RoleUsuario> roles, Long unidadeId) {
}
