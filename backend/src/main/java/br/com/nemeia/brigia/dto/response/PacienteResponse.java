...
public record PacienteResponse(Long id, String nome, String email, String cpf,
        @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd") LocalDate dataNascimento, Character sexo,
        String celular, LocalDateTime ultimaConsulta, LocalDateTime proximaConsulta, String urlImagem,
